...
class PredictBattleScreenup extends StatefulWidget {
  const PredictBattleScreenup({super.key});

  @override
  State<PredictBattleScreenup> createState() => _PredictBattleScreenupState();
}

class _PredictBattleScreenupState extends State<PredictBattleScreenup> {
