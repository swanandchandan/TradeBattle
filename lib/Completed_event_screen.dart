...
class Completed_event extends StatefulWidget {
  const Completed_event({Key? key}) : super(key: key);

  @override
  State<Completed_event> createState() => _Completed_eventState();
}

class _Completed_eventState extends State<Completed_event> {
  int modeButtonIndex = 1;
  int? eventButtonIndex = 5;
                        ...
                        child: TextButton(
                          onPressed: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => const Live_event(),
                              ),
                            );
                            eventButtonIndex = 4;
                            setState(() {});
